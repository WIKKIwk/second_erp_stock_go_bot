...
func (f *fakeERP) ConfirmAndSubmitPurchaseReceipt(_ context.Context, _, _, _, name string, qty, _ float64, _, _ string) (erpnext.PurchaseReceiptSubmissionResult, error) {
	f.confirmName = name
	f.confirmQty = qty
	if f.submitErr != nil {
